...
export const mockProducts = [
  ...
  },
  {
    ...
    shortDescription: 'Airy linen tee with an easy drape.',
    description: 'A soft, breathable top designed for warm-day layering and clean styling.',
    category: 'tops',
    collectionSlug: 'summer-essentials',
    price: 49,
    tags: ['linen', 'summer', 'easywear'],
    featured: false,
    images: [
      '/top9.avif',
    ],
    variants: [
      { _id: 'v29', size: 'S', color: 'Oat', quantity: 9, lowStockThreshold: 3 },
      { _id: 'v30', size: 'M', color: 'Oat', quantity: 7, lowStockThreshold: 3 },
      { _id: 'v31', size: 'L', color: 'Sage', quantity: 5, lowStockThreshold: 3 },
    ],
  },
  {
    _id: 'mock-prod-12',
    name: 'Everyday Rib Tank',
    slug: 'everyday-rib-tank',
    shortDescription: 'Close-fit ribbed tank for daily rotation.',
    description: 'A versatile rib tank that works under tailoring or on its own.',
    category: 'tops',
    collectionSlug: 'metro-minimal',
    price: 39,
    tags: ['basics', 'layering', 'minimal'],
    featured: false,
    images: [
      '/top10.avif',
    ],
    variants: [
      { _id: 'v32', size: 'XS', color: 'White', quantity: 10, lowStockThreshold: 4 },
      { _id: 'v33', size: 'S', color: 'White', quantity: 8, lowStockThreshold: 4 },
      { _id: 'v34', size: 'M', color: 'Black', quantity: 6, lowStockThreshold: 4 },
    ],
  },
  {
    _id: 'mock-prod-13',
    ...
    shortDescription: 'Sharp poplin shirt with a relaxed boxy cut.',
    description: 'A polished top with structure that still feels easy to wear.',
    category: 'tops',
    collectionSlug: 'luxury-investment',
    price: 89,
    tags: ['tailored', 'office', 'classic'],
    featured: true,
    images: [
      '/top11.avif',
    ],
    variants: [
      { _id: 'v35', size: 'S', color: 'Blue Stripe', quantity: 6, lowStockThreshold: 2 },
      { _id: 'v36', size: 'M', color: 'Blue Stripe', quantity: 5, lowStockThreshold: 2 },
      { _id: 'v37', size: 'L', color: 'White', quantity: 4, lowStockThreshold: 2 },
    ],
  },
  {
    _id: 'mock-prod-14',
    ...
    shortDescription: 'Fluid blouse with a refined neckline.',
    description: 'A light drape blouse that reads elevated without feeling formal.',
    category: 'tops',
    collectionSlug: 'evening-studio',
    price: 74,
    tags: ['elevated', 'evening', 'soft'],
    featured: false,
    images: [
      '/top12.avif',
    ],
    variants: [
      { _id: 'v38', size: 'XS', color: 'Pearl', quantity: 7, lowStockThreshold: 3 },
      { _id: 'v39', size: 'S', color: 'Pearl', quantity: 6, lowStockThreshold: 3 },
      { _id: 'v40', size: 'M', color: 'Champagne', quantity: 4, lowStockThreshold: 3 },
    ],
  },
  {
    _id: 'mock-prod-15',
    name: 'Knitted Polo Top',
    slug: 'knitted-polo-top',
    shortDescription: 'Textured knit with a smart collar finish.',
    description: 'A polished knit top that bridges casual and refined dressing.',
    category: 'tops',
    collectionSlug: 'winter-core',
    price: 65,
    tags: ['knitwear', 'smart-casual', 'texture'],
    featured: false,
    images: [
      '/top13.avif',
    ],
    variants: [
      { _id: 'v41', size: 'S', color: 'Charcoal', quantity: 5, lowStockThreshold: 2 },
      { _id: 'v42', size: 'M', color: 'Charcoal', quantity: 5, lowStockThreshold: 2 },
      { _id: 'v43', size: 'L', color: 'Cream', quantity: 4, lowStockThreshold: 2 },
    ],
  },
  {
    _id: 'mock-prod-16',
    ...
    shortDescription: 'Compact knit layer with a clean shape.',
    description: 'An easy cardigan for transitional weather and layered outfits.',
    category: 'tops',
    collectionSlug: 'weekend-atelier',
    price: 69,
    tags: ['layering', 'knit', 'transitional'],
    featured: false,
    images: [
      '/top14.webp',
    ],
    variants: [
      { _id: 'v44', size: 'XS', color: 'Mocha', quantity: 8, lowStockThreshold: 3 },
      { _id: 'v45', size: 'S', color: 'Mocha', quantity: 7, lowStockThreshold: 3 },
      { _id: 'v46', size: 'M', color: 'Stone', quantity: 5, lowStockThreshold: 3 },
    ],
  },
  {
    _id: 'mock-prod-17',
    ...
    shortDescription: 'Wrap-front silhouette with a sharp finish.',
    description: 'A flattering wrap top designed to stand out without heavy styling.',
    category: 'tops',
    collectionSlug: 'luxury-investment',
    price: 84,
    tags: ['statement', 'wrap', 'day-to-night'],
    featured: true,
    images: [
      '/top1.jpg',
    ],
    variants: [
      { _id: 'v47', size: 'S', color: 'Black', quantity: 6, lowStockThreshold: 2 },
      { _id: 'v48', size: 'M', color: 'Black', quantity: 5, lowStockThreshold: 2 },
      { _id: 'v49', size: 'L', color: 'Wine', quantity: 3, lowStockThreshold: 2 },
    ],
  },
  {
    _id: 'mock-prod-18',
    ...
    shortDescription: 'Light overshirt for clean layered looks.',
    description: 'A versatile shirt-jacket hybrid that works across seasons.',
    category: 'tops',
    collectionSlug: 'metro-minimal',
    price: 79,
    tags: ['overshirt', 'layering', 'neutral'],
    featured: false,
    images: [
      '/top2.webp',
    ],
    variants: [
      { _id: 'v50', size: 'S', color: 'Sand', quantity: 9, lowStockThreshold: 3 },
      { _id: 'v51', size: 'M', color: 'Sand', quantity: 7, lowStockThreshold: 3 },
      { _id: 'v52', size: 'L', color: 'Olive', quantity: 4, lowStockThreshold: 3 },
    ],
  },
  {
    _id: 'mock-prod-19',
    ...
    shortDescription: 'Clean everyday tee with a soft hand feel.',
    description: 'A staple cotton tee designed for easy layering and daily rotation.',
    category: 'tops',
    collectionSlug: 'summer-essentials',
    price: 34,
    ...
    images: ['/top3.jpeg'],
    variants: [
      { _id: 'v53', size: 'XS', color: 'White', quantity: 12, lowStockThreshold: 4 },
      { _id: 'v54', size: 'S', color: 'White', quantity: 10, lowStockThreshold: 4 },
      { _id: 'v55', size: 'M', color: 'Black', quantity: 8, lowStockThreshold: 4 },
    ],
  },
  {
    _id: 'mock-prod-20',
    name: 'Satin Button Shirt',
    slug: 'satin-button-shirt',
    shortDescription: 'Glossy shirt with a fluid finish.',
    description: 'An elevated button-up that moves easily from desk to dinner.',
    category: 'tops',
    collectionSlug: 'evening-studio',
    price: 92,
    tags: ['satin', 'evening', 'polished'],
    featured: true,
    images: ['/top4.webp'],
    variants: [
      { _id: 'v56', size: 'S', color: 'Champagne', quantity: 6, lowStockThreshold: 2 },
      { _id: 'v57', size: 'M', color: 'Champagne', quantity: 5, lowStockThreshold: 2 },
      { _id: 'v58', size: 'L', color: 'Black', quantity: 3, lowStockThreshold: 2 },
    ],
  },
  {
    _id: 'mock-prod-21',
    name: 'Fine Gauge Crew',
    slug: 'fine-gauge-crew',
    shortDescription: 'Light knit crew with a polished line.',
    description: 'A refined crew-neck knit that layers well under jackets or coats.',
    category: 'tops',
    collectionSlug: 'metro-minimal',
    price: 58,
    tags: ['knit', 'minimal', 'layering'],
    featured: false,
    images: ['/top5.webp'],
    variants: [
      { _id: 'v59', size: 'XS', color: 'Grey', quantity: 9, lowStockThreshold: 3 },
      { _id: 'v60', size: 'S', color: 'Grey', quantity: 7, lowStockThreshold: 3 },
      { _id: 'v61', size: 'M', color: 'Cream', quantity: 6, lowStockThreshold: 3 },
    ],
  },
  {
    _id: 'mock-prod-22',
    name: 'Structured Sleeveless Top',
    slug: 'structured-sleeveless-top',
    shortDescription: 'Sleeveless cut with tailored shape.',
    description: 'A crisp sleeveless top that adds structure to warm-weather outfits.',
    category: 'tops',
    collectionSlug: 'luxury-investment',
    price: 66,
    tags: ['tailored', 'sleeveless', 'modern'],
    featured: false,
    images: ['/top6.jpg'],
    variants: [
      { _id: 'v62', size: 'XS', color: 'White', quantity: 7, lowStockThreshold: 3 },
      { _id: 'v63', size: 'S', color: 'White', quantity: 6, lowStockThreshold: 3 },
      { _id: 'v64', size: 'M', color: 'Black', quantity: 4, lowStockThreshold: 3 },
    ],
  },
  {
    _id: 'mock-prod-23',
    ...
    shortDescription: 'Soft drape with a clean, modern neckline.',
    description: 'A lightweight jersey top designed for effortless day-to-night styling.',
    category: 'tops',
    collectionSlug: 'evening-studio',
    price: 62,
    tags: ['jersey', 'draped', 'versatile'],
    featured: false,
    images: ['/top 15.jpg'],
    variants: [
      { _id: 'v65', size: 'S', color: 'Espresso', quantity: 7, lowStockThreshold: 3 },
      { _id: 'v66', size: 'M', color: 'Espresso', quantity: 6, lowStockThreshold: 3 },
      { _id: 'v67', size: 'L', color: 'Black', quantity: 4, lowStockThreshold: 3 },
    ],
  },
  {
    _id: 'mock-prod-24',
    name: 'Kids Play Tee',
    slug: 'kids-play-tee',
    shortDescription: 'Soft cotton tee for active days.',
    description: 'Breathable everyday tee designed for comfort, movement, and easy care.',
    category: 'tops',
    collectionSlug: 'summer-essentials',
    price: 29,
    tags: ['kids', 'cotton', 'daily'],
    featured: false,
    images: ['/kid7.webp'],
    variants: [
      { _id: 'v68', size: '4Y', color: 'Sky Blue', quantity: 10, lowStockThreshold: 4 },
      { _id: 'v69', size: '6Y', color: 'Sky Blue', quantity: 8, lowStockThreshold: 4 },
      { _id: 'v70', size: '8Y', color: 'Lime', quantity: 6, lowStockThreshold: 4 },
    ],
  },
  {
    _id: 'mock-prod-25',
    ...
    shortDescription: 'Stretch jogger with easy waistband.',
    description: 'Durable joggers built for playtime with a flexible fit and soft interior.',
    category: 'bottoms',
    collectionSlug: 'winter-core',
    price: 34,
    tags: ['kids', 'jogger', 'comfort'],
    featured: false,
    images: ['/kid8.webp'],
    variants: [
      { _id: 'v71', size: '4Y', color: 'Navy', quantity: 9, lowStockThreshold: 3 },
      { _id: 'v72', size: '6Y', color: 'Navy', quantity: 7, lowStockThreshold: 3 },
      { _id: 'v73', size: '8Y', color: 'Graphite', quantity: 5, lowStockThreshold: 3 },
    ],
  },
  {
    _id: 'mock-prod-6',
