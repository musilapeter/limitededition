...
export const HomePage = () => {
  ...
  return (
    <div className="space-y-10 fade-in">
      <section className="rounded-3xl border border-white/10 bg-hero-glow p-5 sm:p-8">
        <p className="text-xs uppercase tracking-[0.4em] text-sand">Clothline House</p>
        <h1 className="mt-4 max-w-3xl font-heading text-3xl leading-tight sm:text-4xl md:text-6xl">
        ...
        <Link to="/products" className="mt-6 inline-block rounded-full bg-pearl px-6 py-3 text-sm font-bold text-ink">
          Explore Pieces
        </Link>
      </section>
      ...
      <section className="space-y-4">
        <div className="flex flex-col items-start justify-between gap-2 sm:flex-row sm:items-end">
          ...
          <Link to="/collections" className="text-sm text-sand underline underline-offset-4">
